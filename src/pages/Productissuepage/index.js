...
const ProductissuepagePage = () => {
  ...
  if (checkInfo.length) {
    ...
    //console.log("apidacheckedDatata",checkData);
  ...
  return (
    <>
      <Column className="bg-gray_50 font-sourcesanspro items-center mx-[auto] pb-[10px] 3xl:pb-[12px] lg:pb-[7px] xl:pb-[8px] w-[100%]">
        ...
        <Column className="items-center mt-[1px] w-[90%]">
          ...
          <Column className="bg-white_A700 font-inter items-center lg:mt-[20px] xl:mt-[23px] mt-[26px] 3xl:mt-[31px] lg:py-[18px] xl:py-[21px] py-[24px] 3xl:py-[28px] rounded-radius16 shadow-bs w-[100%]">
            <Row className="items-center w-[98%]">
              <Text className="font-actor font-normal not-italic lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-black_900 w-[auto]">
                Project Issues List
              </Text>
            ...
            <Column className="lg:mb-[31px] xl:mb-[35px] mb-[40px] 3xl:mb-[48px] lg:mt-[28px] xl:mt-[32px] mt-[37px] 3xl:mt-[44px] w-[100%]">
              ...
              >
                {apiData?.map((apiDataResponseEle) => {
                  return (
                    ...
                    <Row className="items-center my-[0] w-[100%]">
                      <Stack className="bg-white_A700 border-bw05 border-gray_200 border-solid  px-[11px] 3xl:px-[13px] lg:px-[8px] xl:px-[9px] w-[6%] max-w-[100px] h-[100%] justify-center items-center " >
                        <CheckBox
                          className="bottom-[0] right-[26%] "
                          inputClassName="mr-[5px] w-[undefinedpx]"
                          name="square"
                      ...
                      <Text className="bg-white_A700 border-bw05 border-gray_200 border-solid font-normal lg:leading-[17px] xl:leading-[19px] leading-[22.00px] 2xl:leading-[22px] 3xl:leading-[26px] not-italic lg:pl-[17px] xl:pl-[19px] pl-[22px] 3xl:pl-[26px] py-[11px] 3xl:py-[13px] lg:py-[8px] xl:py-[9px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_900 tracking-ls1 w-[16%] h-[100%] justify-start items-center max-w-[200px]">
                        {apiDataResponseEle?.type}
                      </Text>
                      <Column className="bg-white_A700 border-bw05 border-gray_200 border-solid font-sourcesanspro items-center lg:p-[4px] xl:p-[5px] p-[6px] 3xl:p-[7px] w-[13%] h-[100%] d-flex justify-start items-center">
                        <Button
...
export default ProductissuepagePage;
